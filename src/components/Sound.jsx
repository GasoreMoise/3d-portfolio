    ...
    return createPortal(
        <div className='fixed inset-0 bg-background/60 backdrop-blur-sm flex items-center justify-center '>
            ...
            py-8 px-6 xs:px-10 sm:px-16 rounded shadow-glass-inset text-center space-y-8'>
                ...
                <button onClick={onClose} clasName="px-4 py-2 border border-accent/30 border-solid hover:shadow-glass-sm rounded">No</button>
                </div>
            </div>
    ...
    return (
        <div className='fixed top-4 right-2.5 xs:right-4 z-50 group'>
            ...
            <audio ref={audioRef} loop>
                ...
                <source src={"/audio/morning's wings.mp3"} type="audio/mpeg" />
