...
import { Home, Linkedin, User, Phone, Palette, Github, Twitter, NotebookText} from 'lucide-react';
    ...
    <ResponsiveComponent>
        {({size}) => {
            ...
            >
                <NavLink
                variants={item}
                href={link} target={newTab ? '_blank' : '_self'} className='text-foreground rounded-full flex items-center justify-center custom-bg' 
